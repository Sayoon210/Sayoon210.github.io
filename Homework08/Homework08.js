...
// shader uniform int 변수로 u_quantLevel을 통해 toonLevels를 넘겨받음
// texture 대신 단색을 사용
// main 함수에서 smooth shading을 기본값으로 설정
----------------------------------------------------------------------------------*/
...
const lightDirection = vec3.fromValues(1.0, 0.25, 0.5); // 확인 필요
...
function render() {
    ...
    //console.log(toonLevels);
    shader.setInt('u_quantLevel', toonLevels);
